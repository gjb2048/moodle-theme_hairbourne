Introduction
============
HairBourne theme for learning about Mustache templates in Moodle themes.

![image1](pix/screenshot.png "HairBourne Screenshot")

[![Build Status](https://travis-ci.org/gjb2048/moodle-theme_hairbourne.svg?branch=master)](https://travis-ci.org/gjb2048/moodle-theme_hairbourne)
...
Free Software
=============
The HairBourne theme is 'free' software under the terms of the GNU GPLv3 License, please see 'COPYING.txt'.

It can be obtained for free from:
https://moodle.org/plugins/view.php?plugin=theme_hairbourne
and
https://github.com/gjb2048/moodle-theme_hairbourne/releases
...
https://github.com/gjb2048/moodle-theme_hairbourne and doing a 'Pull Request' so that the rest of the
Moodle community benefits.

Support
=======
As HairBourne is licensed under the GNU GPLv3 License it comes with NO support.  If you would like support from
...
============
 ...
 3. Copy the extracted 'hairbourne' folder to the '/theme/' folder.
...
=========
 1. Ensure you have the version of Moodle as stated above in 'Required version of Moodle'.  This is essential as the
    theme relies on underlying core code that is out of my control.
 2. Login as an administrator and put Moodle in 'Maintenance Mode' so that there are no users using it bar you as the administrator.
 3. Make a backup of your old 'hairbourne' folder in '/theme/' and then delete the folder.
 4. Copy the replacement extracted 'hairbourne' folder to the '/theme/' folder.
...
==============
 ...
 3. In '/theme/' remove the folder 'hairbourne'.
...
Thanks
======
My thanks go to Urs Hunkler for the CleanM theme.
